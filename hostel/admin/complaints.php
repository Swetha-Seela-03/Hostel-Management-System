  ...
  <body>
    ...
    <?php
      ...
      function sorted() {
        ...
        $regno1=$_POST['id'];
        $sql1="UPDATE `complaints` SET `status`='sorting' where regno='$regno1'";
      ...
      function decline() {
        ...
        $regno1=$_POST['id'];
        echo $regno1;
        $sql1="UPDATE `complaints` SET `status`='declined' where regno='$regno1'";
        $query1=mysqli_query($conn,$sql1);
        if($query1){
          //echo 'successful';
   ...
   ?>
    <form class="" action="complaints.php" method="post">
    ...
    <td><?php echo $rows['roomno']; ?></td>
      <td><?php echo $rows['reason']; ?></td>
        ...
        if($rows['status']=="Pending"){
         ?>
        <td>
          <input type="submit" name="sort" class="approvebtn" value="sort">
...
<?php } ?>
  ...
  <?php
    ...
    <button type="button" name="button" class="NavBtnLink" onclick="back()" style="margin:20px 650px" >BACK</button>
</html>
